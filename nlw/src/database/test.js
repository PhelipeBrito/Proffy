...
Database.then(async (db) => {
    ...
    //Consult the classes from a specified proffy
    // and show the data of the teacher
    ...
    const selecteClassesSchedule = await db.all(`
    ...
    console.log(selecteClassesSchedule);
})